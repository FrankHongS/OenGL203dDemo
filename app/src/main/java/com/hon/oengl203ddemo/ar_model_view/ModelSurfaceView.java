package com.hon.oengl203ddemo.ar_model_view;
...
public class ModelSurfaceView extends GLSurfaceView {
    ...
    private static final String TAG = ModelSurfaceView.class.getSimpleName();

    private BaseActivity parent;

    private GLRenderer mRenderer;

//    protected TouchController touchHandler;

    public enum TargetRenderingAPI{
        OPENGL_ES_2, OPENGL_ES_3
    }

    public ModelSurfaceView(final BaseActivity context, final GLRenderer renderer, final TargetRenderingAPI... targetRenderingAPIs) {
        this(context, renderer, null, targetRenderingAPIs);
    }

    public ModelSurfaceView(final BaseActivity context, final GLRenderer renderer, final AttributeSet attrs, final TargetRenderingAPI... targetRenderingAPIs) {
        super(context, attrs);

        if (ModelSurfaceView.this.getContext() == null || ModelSurfaceView.this.getContext() instanceof Activity && ((Activity) ModelSurfaceView.this.getContext()).isFinishing()) {
            return;
        }
        ...
        mRenderer = renderer;
        parent=context;
//        touchHandler=new TouchController(this,mRenderer.getDisplay());
...
//    }
    ...
    public BaseActivity getModelActivity() {
        return parent;
    }
